...
class ClistAdmin(admin.ModelAdmin):
    list_display = ('year', 'course_title', 'course_code','faculty',"departments","dep_code", "location", "description", "student_count")
    search_fields = ('course_title', 'course_code')

@admin.register(Department)
class DepartmentAdmin(admin.ModelAdmin):
    list_display = ('dep_name','dep_code','faculty')
    search_fields = ('dep_name','faculty')
